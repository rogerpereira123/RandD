...
set Score= Score + (
case 
when PPH >= 8.25 then 45 
when PPH >= 6.76 then 30
when PPH >= 6 then 15 
else 0 end  
)
...
set Score= Score + (
case 
when TC30 <= 4.5 then 45 
when TC30 <= 5 then 30
when TC30 <= 5.50 then 15
else 0 
end
) where PPH > 0
...
set Score= Score + (
case 
when CSAT >= 9.72 then 15 
when CSAT >= 9.7 then 10
when CSAT >= 9.6 then 5
else 0
end
)
...
set Score= Score + (
case 
when SHSPerWO >= 14 then 30
when SHSPerWO >= 12 then 20
when SHSPerWO >= 9 then 10
else 0
end
)
